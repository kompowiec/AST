...
void menu()
{
	...
	printf("Jeśli chcesz wrócić do głównego menu,          wciśnij gwiazke (*).\n");
}
void account() //1
{
	printf("Masz 3,44 zł ważne do 2015-11-2 23;59.\n");
	printf("UWAGA! Usługa Automatycznego Systemu Telefonicznego jest płatna.\n");
...
void doladowanie()
{
	...
	printf("Aby wybrać kod kuponu jeszcze raz,      wciśnij 1.\n");
